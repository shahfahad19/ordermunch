...
const DeleteRestaurantBtn = () => {
    ...
    const deleteRestaurant = async (event) => {
        ...
        await axios
            .delete(`${ctx.baseURL}/restaurants/${params.restaurantId}`, ctx.headers)
            .then(() => {
            ...
            {showConfimationModal && (
                <>
                    <ModalWrapper>
                        ...
                        <span>This restaurant will be deleted permanently from database!</span>
                        <div className='flex gap-3'>
                            <ModalButton className={'btn-error ' + btnState} handler={deleteRestaurant}>
                                Delete
                            </ModalButton>

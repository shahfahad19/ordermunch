...
const CustomerSidebar = () => {
    ...
    return (
        <div className='fixed flex flex-col left-0 w-14 md:w-64 bg-blue-700 h-full text-white transition-all duration-300 border-none z-10 sidebar'>
                ...
                <ul className='flex flex-col py-4 space-y-1'>
                    ...
                    <li onClick={() => openPage('')}>
                        ...
                        >
                            ...
                            <span className='ml-2 text-sm tracking-wide truncate'>Info</span>
                        </span>
                    </li>
